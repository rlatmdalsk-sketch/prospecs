...
function Register() {
    ...
    return (
        <>
            <div
                className={twMerge("flex", "flex-col", "min-h-[80dvh]", "px-4", "py-40", [
                    "justify-center",
                    "items-center",
                ])}>
                ...
                <form
                    ...
                    <Button type={"submit"} isLoading={isSubmitting} fullWidth={true} size={"lg"}>회원가입</Button>
                </form>
            </div>
        </>
    );
